...
func NewGatewayDeployment(instance *gramolav1alpha1.AppService, scheme *runtime.Scheme) (*appsv1.Deployment, error) {
...
func NewGatewayService(instance *gramolav1alpha1.AppService, scheme *runtime.Scheme) (*corev1.Service, error) {
	labels := GetAppServiceLabels(instance, GatewayServiceName)
...
func NewGatewayRoute(instance *gramolav1alpha1.AppService, scheme *runtime.Scheme) (*routev1.Route, error) {
	labels := GetAppServiceLabels(instance, GatewayServiceName)
